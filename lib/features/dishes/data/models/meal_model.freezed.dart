...
abstract class _MealModel extends MealModel {
  const factory _MealModel(
      ...
      final String? strImageSource,
      final String? strCreativeCommonsConfirmed,
      final String? dateModified}) = _$MealModelImpl;
